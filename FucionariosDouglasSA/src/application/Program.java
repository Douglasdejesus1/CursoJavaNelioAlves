...
public class Program {
	...
	public static void main(String[] args) {
			...
			System.out.println("Quantos funcionarios há na empresa?");
			int N=sc.nextInt();
			...
			for (int i=0;i<N;i++) {
				...
				System.out.print("Qual é a Carga Horaria: ");
			...
			char saida;
			do{
			System.out.println("Qual o ID do funcionario que irá ter o Valor Hora alterado?");
			...
			saida='s';
			do{
			System.out.println("Qual o ID do funcionario que irá ter a carga horaria alterada?");
